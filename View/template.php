...
<div class="body-wrapper">
    <nav class="navbar navbar-default" role="navigation">
        <div class="navbar-header"><a class="btn responsive-menu" data-toggle="collapse" data-target=".navbar-collapse"><i></i></a>
            <div class="navbar-brand text-center"><a href="/home"><img src="/style/images/logo.png" alt="" data-src="/style/images/logo.png" data-ret="/style/images/logo@2x.png"
                                                                   class="retina"/></a></div>
            <!-- /.navbar-brand -->
        </div>
        <!-- /.navbar-header -->
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="current"><a href="/home#home" class="hint--right" data-hint="Accueil"><i class="budicon-home-1"></i><span>Accueil</span></a></li>
                <li><a href="/home#about" class="hint--right" data-hint="Résumé du livre"><i class="budicon-note-9"></i><span>Résumé du livre</span></a></li>
                <!-- Portfolio
                <li><a href="#portfolio" class="hint--right" data-hint="pas util"><i class="budicon-image"></i><span>Portfolio</span></a></li>
                -->
                <li><a href="/page" class="hint--right" data-hint="Lire le livre"><i class="budicon-book-1"></i><span>Lire le livre</span></a></li>
                <li><a href="/home#contact" class="hint--right" data-hint="Contact"><i class="budicon-profile"></i><span>Contact</span></a></li>
                ...
                <?php else : ?>
                <li><a href="/home#register" class="hint--right" data-hint="Inscription"><i class="budicon-author"></i><span>Inscription</span></a></li>
                <li><a href="/home#connexion" class="hint--right" data-hint="Connexion"><i class="budicon-lock"></i><span>Connexion</span></a></li>
